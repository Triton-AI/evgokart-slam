...
class ObjectDetectionPublisher(Node):
    ...
    def camera_model(self):
        ...
        with dai.Device() as device:
            model = torch.hub.load('/home/projects/ultralytics_yolov5_master', 'custom', path=str((Path(__file__).parent / Path('../models/box_cone_v10/Custom_Object_Detection_using_YOLOv5_512.pt')).resolve().absolute()), source='local', force_reload=True)
